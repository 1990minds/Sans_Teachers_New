...
import { coscholastic1to4Selector, createcoscholastic1to4, fetchOneCoscholastic1to4, updateCoscholastic1to4 } from '../../api/coscholastic1to4'

export default function Coscholastic1to4() {
...
const {current_coscholastic1to4} = useSelector(coscholastic1to4Selector)
...
dispatch(fetchOneCoscholastic1to4(id))
},[id])
...
{current_coscholastic1to4 && current_coscholastic1to4[0]?.[term]?.status === 'Finish' ? (
...
<div className='w-[90%] flex gap-6 bg-[#E4E6EA] pt-2 mb-2 pl-2'>
  ...
  <Box sx={{display:'flex', gap:'24px',  marginBottom:'6px'}} spacing={2}>
  <Typography  className='w-[54%]  'sx={{fontSize:'14px', fontWeight:'400', }}>Reads fluently</Typography>
  <div  >
  <input
   type="text"
  label="enter marks"
...
//  pattern="^\d*\.?\d*$" 
  />
   ...
   <Box sx={{ display: 'flex', gap: '24px', marginBottom: '6px' }} spacing={2}>
   <Typography  className='w-[54%] 'sx={{fontSize:'14px', fontWeight:'400', }}> Applies phonic skills</Typography>
   <div>
   <input
   type="text"
   name="skills_marks"
...
//  pattern="^\d*\.?\d*$" 
  ...
  // pattern="^\d*\.?\d*$" 
   ...
   <Box  spacing={2}>
   <div className='w-[90%] flex gap-6 bg-[#E4E6EA] pt-2 mb-2 pl-2'>
    <Typography sx={{ width:'60%', fontSize:'16px', fontWeight:'500',  marginBottom:'12px', }}>Specials : Participates Co-operatively/effort in
    (Co-curricular Activities)</Typography>
    <div>
    <input
    type="text"
...
//  pattern="^\d*\.?\d*$" 
  ...
  <Box  spacing={1}>
  <div className='w-[90%] flex gap-6 bg-[#E4E6EA] pt-2 mb-2 pl-2'>
    <Typography sx={{ width:'60%', fontSize:'16px', fontWeight:'500' , display: 'flex',  gap:'24px', marginBottom:'12px', }}>Written Expression (Co-curricular Activities)    </Typography>
    <div>
    <input
    type="text"
...
//  pattern="^\d*\.?\d*$" 
  ...
  //  pattern="^\d*\.?\d*$" 
   ...
   type="text" 
   name="beads_marks"
   value={scholasticData.beads_marks}
   onChange={(e) => {
    handleChange(e);
    onChangeTotal7("beads_marks", e.target.value);
  }}
   size="small"
   className='border border-neutral-500 w-16 rounded-sm text-center'
   maxLength="3"
  ...
  // pattern="^\d*\.?\d*$" 
   />
    ...
    name="beads_grade"
    label="Grade"
    value={scholasticData.beads_grade}
    size="small"
    className=' border  border-neutral-500 w-16 rounded-sm text-center text-white'
    style={{
      backgroundColor: getBackgroundColor(scholasticData.beads_grade),
    }}
    />
  </div>
  </Box>
  ...
  <input
   type="text"
  label="enter marks"
  name="visualise_marks"
  value={scholasticData.visualise_marks}
  onChange={(e) => {
    handleChange(e);
    onChangeTotal7("visualise_marks", e.target.value);
  }}
  size="small"
  className=' border  border-neutral-500 w-16 rounded-sm text-center'
  maxLength="3"
...
//  pattern="^\d*\.?\d*$" 
  />
   ...
   <div>
   <input
   name="visualise_grade"
   label="Grade"
   value={scholasticData.visualise_grade}
   size="small"
   className=' border  border-neutral-500 w-16 rounded-sm text-center text-white'
   style={{
    backgroundColor: getBackgroundColor(scholasticData.visualise_grade),
  }}
   />
  </div>
  </Box>
